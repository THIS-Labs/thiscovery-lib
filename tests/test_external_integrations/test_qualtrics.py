...
class TestResponsesClient(unittest.TestCase):
    ...
    def test_responses_01_retrieve_response_ok(self):
        response = self.responses_client.retrieve_response(
    ...
    def test_responses_02_retrieve_schema_ok(self):
        ...
        self.assertEqual("200 - OK", response["meta"]["httpStatus"])
        expected_values_properties_keys = [
            "QID1",
            "QID10_1",
            "QID10_13",
            "QID10_15",
        ...
        self.assertCountEqual(
            expected_values_properties_keys,
            response["result"]["properties"]["values"]["properties"].keys(),
        )
...
class TestDistributionsClient(unittest.TestCase):
    ...
    def test_dist_01_create_retrieve_and_delete_individual_links_ok(self):
        ...
        r = self.dist_client.create_individual_links(
            survey_id=self.test_survey_id, contact_list_id=self.test_contact_list_id
        )
        ...
        r = self.dist_client.list_distribution_links(
            distribution_id, self.test_survey_id
        )
        self.assertEqual("200 - OK", r["meta"]["httpStatus"])
